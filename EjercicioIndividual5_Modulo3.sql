-- Ejercicio Individual 5 Modulo 3

-- Parte 1 - Creacion de Base de Datos y usuario con todos los privilegios.
CREATE DATABASE	capacitame_new;
CREATE USER 'capacitame_user'@'localhost' IDENTIFIED BY 'user123';
GRANT ALL PRIVILEGES ON capacitame_new.* TO 'capacitame_user'@'localhost';
FLUSH PRIVILEGES;
...
-- Parte 3 - Creación de registros para las tablas
...
-- Creación de tabla detalle_visitas
...
-- Fin creación de tabla detalle_visitas

-- PARTE 4 - Eliminar una tabla
DROP TABLE detalle_visitas;
-- Fin de eliminar una tabla
